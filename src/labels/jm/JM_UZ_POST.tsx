...
export default function JM_UZ_POST(props){
    ...
    const renderTable=(_data, border = null)=>{
        return(
            <View style={{
                ...
                <View style={{width:'25%', textAlign:'center', display:'flex', justifyContent:'center'}}>
                    <Text>{_data[1]}</Text>
                </View>
                <View style={{width:'25%', textAlign:'center', display:'flex', justifyContent:'center'}}>
                    <Text>{_data[2]}</Text>
                                        ...
                                        <View style={{width:'70%', textAlign:'center', display:'flex', justifyContent:'flex-end', }}>
                                            <View style={{
                                                ...
                                                <View style={{
                                                    ...
                                                    <Image style={{width:25}} src={imgList['uz_post_logo']}/>
                                                </View>
                                            </View>
                                ...
                                <View style={{display:'flex', flexDirection:'row', lineHeight:1}}>
                                    <View style={{width:'100%', padding:3}}>
...

                                        {
                                            receiptData.productsInfo
                                                ...
                                                .map((product, i) => {
                                                    ...
                                                    return (
                                                        <View key={i} style={{width:'100%', display: "flex", flexDirection: "row"}}>
                                        ...
                                        <View style={{width:'100%', textAlign : 'center'}}>
                                            <Text>{receiptData.productsInfo.length > 7 && '...Showing first 7 items only.'}</Text>
                                        </View>
                                    </View>
                                </View>
                                <View style={{
                                    ...
                                    <Image style={{height:20, width:25, marginRight:2, marginLeft:2}} src={imgList['scan']} />
