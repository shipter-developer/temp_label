...
export default function UZ_POST(props){
                        ...
                        <View style={{width:'100%', height:'100%'}}>
                            ...
                            <View style={{display:'flex', flexDirection:"column", justifyContent:"space-between",
                                ...
                                <View style={{
                                    ...
                                    <Image style={{height:20, width:25, marginRight:2, marginLeft:2}} src={'src/img/LT_POST/scan.png'} />
                                    <Image style={{height:20, width:30}} src={'src/img/LT_POST/no_signature.png'} />
                                </View>
                            </View>
