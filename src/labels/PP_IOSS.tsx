...
export default function PP_IOSS(props){
            ...
            <View style={{border:'2px solid black', width:'100%', height:'100%'}}>
                ...
                <View style={{display:'flex', flexDirection:"column", justifyContent:"space-between",
                    ...
                    <View style={{
                        ...
                        <Image style={{height:30, width:50, marginRight:5}} src='src/img/LT_POST/scan.png' />
                        <Image style={{height:30, width:70}} src='src/img/LT_POST/no_signature.png' />
                    </View>
                </View>
