...
exports.default = JM_SK_POST_CN22_PRIME;
...
function JM_SK_POST_CN22_PRIME(props) {
    ...
    return (react_1.default.createElement(renderer_1.Page, { size: { width: 432, height: 288 }, orientation: "portrait", style: {
        ...
        react_1.default.createElement(renderer_1.View, { style: {
            ...
            react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', width: '100%' } },
                react_1.default.createElement(renderer_1.View, { style: {
                    ...
                    react_1.default.createElement(renderer_1.View, { style: {
                        ...
                        react_1.default.createElement(renderer_1.View, null,
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { paddingTop: 3, diaplay: "flex", flexDirection: "row", justifyContent: "space-between", } },
                                react_1.default.createElement(renderer_1.Text, null, "Designated operator SLOVAK POST"))),
                        react_1.default.createElement(renderer_1.View, null,
                            react_1.default.createElement(renderer_1.Text, { style: { fontSize: 13 } },
                                "CN22",
                                ' '))),
                    react_1.default.createElement(renderer_1.View, { style: {
                        ...
                        return (react_1.default.createElement(renderer_1.View, { key: i, style: { minWidth: i % 3 == 1 ? '35%' : '25%', display: 'flex', flexDirection: 'row', margin: '1px 0px' } },
                            react_1.default.createElement(renderer_1.Image, { src: i == 5 ? imgList['check'] : imgList['uncheck'], style: { height: 5, marginRight: 2 } }),
                ...
                react_1.default.createElement(renderer_1.View, { style: { width: '63%', fontSize: 6 } },
                    react_1.default.createElement(renderer_1.View, { style: { width: '100%', height: '100%' } },
                        react_1.default.createElement(renderer_1.View, { style: {
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { width: '45%', display: 'flex', flexDirection: 'row', alignItems: 'center' } },
                                react_1.default.createElement(renderer_1.View, { style: { padding: 5 } },
                                    react_1.default.createElement(renderer_1.Text, null, "From/Odosielate\u013E:"),
                                    react_1.default.createElement(renderer_1.Text, null, "PostPlus \u2013 meno odosielate\u013Ea, P.O.Box 0200, Bratislava 090"),
                                    react_1.default.createElement(renderer_1.Text, null, "800 90 Braislava"),
                                    react_1.default.createElement(renderer_1.Text, null, "SLOVAKIA"))),
                            react_1.default.createElement(renderer_1.View, { style: { width: '55%', fontSize: 7, padding: 2 } },
                                react_1.default.createElement(renderer_1.View, { style: { width: '100%', height: '100%', display: 'flex', flexDirection: 'row', border: '2px solid black' } },
                                    react_1.default.createElement(renderer_1.View, { style: { width: '40%', borderRight: '2px solid black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' } },
                                        react_1.default.createElement(renderer_1.Image, { style: { height: '95%' }, src: imgList['logo'] })),
                                    react_1.default.createElement(renderer_1.View, { style: { width: '60%', textAlign: 'center' } },
                                        react_1.default.createElement(renderer_1.View, { style: {
                        ...
                        react_1.default.createElement(renderer_1.View, { style: { width: '100%', backgroundColor: 'black', color: 'white', fontSize: 13, textAlign: 'center', letterSpacing: 1.5, paddingBottom: 3 } },
                            react_1.default.createElement(renderer_1.Text, null, "PRIORITY")),
                        react_1.default.createElement(renderer_1.View, { style: {
                                borderBottom: '1px solid black',
                                height: '20%',
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', height: '100%', width: '100%' } },
                                react_1.default.createElement(renderer_1.View, { style: {
                                    ...
                                    react_1.default.createElement(renderer_1.View, null,
                                        react_1.default.createElement(renderer_1.Text, { style: { fontWeight: "bold", fontSize: 12, padding: '0px 3px' } }, "TO")),
                                    react_1.default.createElement(renderer_1.View, { style: { padding: 2,
                                        ...
                                        react_1.default.createElement(renderer_1.View, null,
                                            ...
                                            react_1.default.createElement(renderer_1.Text, null, receiptData.packageInfo.nation_name)))),
                                react_1.default.createElement(renderer_1.View, { style: { width: '45%', display: 'flex', justifyContent: 'space-between' } },
                                    react_1.default.createElement(renderer_1.View, { style: { width: '100%', paddingTop: 5, display: 'flex', flexDirection: 'row', justifyContent: 'center' } },
                                        react_1.default.createElement(renderer_1.Image, { style: { width: 9, height: 9, marginRight: 10, marginTop: 2 }, src: imgList['phone'] }),
                        ...
                        react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: "column", justifyContent: "space-between",
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', lineHeight: 1 } },
                                react_1.default.createElement(renderer_1.View, { style: { width: '100%', padding: 3 } },
                                    react_1.default.createElement(renderer_1.View, { style: { marginBottom: 2, fontSize: 8, lineHeight: 1.2 } },
                                        react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: "center" } },
                                            react_1.default.createElement(renderer_1.View, null,
                                                react_1.default.createElement(renderer_1.Text, null,
                                                    "Order No: ",
                                                    receiptData.packageInfo.start_track_no ? ` / ${receiptData.packageInfo.start_track_no}` : '')),
                                            receiptData.packageInfo.country_code == 'BA' &&
                                                react_1.default.createElement(renderer_1.View, { style: { paddingRight: 2 } },
                                                    react_1.default.createElement(renderer_1.Text, { style: { fontSize: 20 } }, target[(receiptData.receiverInfo.zip).toString()] || 'ERR')))),
                            ...
                            react_1.default.createElement(renderer_1.View, { style: {
                                ...
                                react_1.default.createElement(renderer_1.Image, { style: { height: 20, width: 30, marginRight: 5 }, src: imgList['scan'] }),
                                react_1.default.createElement(renderer_1.Image, { style: { height: 20, width: 30 }, src: imgList['no_signature'] }),
                                react_1.default.createElement(renderer_1.View, { style: { marginLeft: 15, textAlign: 'center' } }, receiptData.packageInfo.country_code == 'ME' &&
                                    react_1.default.createElement(renderer_1.Text, { style: { fontSize: 8, fontWeight: 'bold' } },
                        ...
                        react_1.default.createElement(renderer_1.View, { style: { width: '100%', display: 'flex', flexGrow: 1, alignItems: 'center', justifyContent: 'space-between' } },
                            react_1.default.createElement(renderer_1.View, { style: { fontSize: 6, padding: '5px 0px 0px 5px', width: '100%' } },
                                react_1.default.createElement(renderer_1.Text, null,
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'center' } },
                                react_1.default.createElement(renderer_1.Image, { style: { width: '90%' }, source: { uri: barcodeUrl } })),
