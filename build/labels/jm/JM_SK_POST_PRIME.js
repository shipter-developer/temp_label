...
exports.default = JM_SK_POST_PRIME;
...
function JM_SK_POST_PRIME(props) {
        ...
        react_1.default.createElement(renderer_1.View, { style: { border: '2px solid black', width: '100%', height: '100%' } },
            react_1.default.createElement(renderer_1.View, { style: {
                ...
                react_1.default.createElement(renderer_1.View, { style: { width: '45%', display: 'flex', flexDirection: 'row', alignItems: 'center' } },
                    react_1.default.createElement(renderer_1.View, { style: { padding: 5, fontSize: 7 } },
            ...
            react_1.default.createElement(renderer_1.View, { style: { width: '100%', backgroundColor: 'black', color: 'white', fontSize: 15, textAlign: 'center', letterSpacing: 1.5 } },
                react_1.default.createElement(renderer_1.Text, null, "STANDARD")),
            react_1.default.createElement(renderer_1.View, { style: {
                    borderBottom: '1px solid black',
                    minHeight: '20%',
                ...
                react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', height: '100%', width: '100%' } },
                    react_1.default.createElement(renderer_1.View, { style: {
                        ...
                        react_1.default.createElement(renderer_1.View, { style: { padding: '5px 5px',
                    ...
                    react_1.default.createElement(renderer_1.View, { style: { width: '40%', display: 'flex', justifyContent: 'space-between' } },
            ...
            react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: "column", justifyContent: "space-between",
                ...
                react_1.default.createElement(renderer_1.View, { style: {
                    ...
                    react_1.default.createElement(renderer_1.Image, { style: { height: 30, width: 50, marginRight: 5 }, src: imgList['scan'] }),
                    react_1.default.createElement(renderer_1.Image, { style: { height: 30, width: 50 }, src: imgList['no_signature'] }))),
