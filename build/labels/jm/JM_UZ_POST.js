                                    ...
                                    react_1.default.createElement(renderer_1.View, { style: { width: '70%', textAlign: 'center', display: 'flex', justifyContent: 'flex-end', } },
                                        react_1.default.createElement(renderer_1.View, { style: {
                                            ...
                                            react_1.default.createElement(renderer_1.View, { style: {
                                                ...
                                                react_1.default.createElement(renderer_1.Image, { style: { width: 25 }, src: imgList['uz_post_logo'] }))),
                            ...
                            react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', lineHeight: 1 } },
                                react_1.default.createElement(renderer_1.View, { style: { width: '100%', padding: 3 } },
                                    ...
                                    receiptData.productsInfo
                                        ...
                                        return (react_1.default.createElement(renderer_1.View, { key: i, style: { width: '100%', display: "flex", flexDirection: "row" } },
                                            react_1.default.createElement(renderer_1.Text, { style: { fontSize: 7, lineHeight: 1.2 } }, description)));
                                    }),
                                    react_1.default.createElement(renderer_1.View, { style: { width: '100%', textAlign: 'center' } },
                                        react_1.default.createElement(renderer_1.Text, null, receiptData.productsInfo.length > 7 && '...Showing first 7 items only.')))),
                            react_1.default.createElement(renderer_1.View, { style: {
                                    display: 'flex', flexDirection: 'row',
                                    alignItems: 'center', justifyContent: 'center'
                                } },
                                react_1.default.createElement(renderer_1.Image, { style: { height: 20, width: 25, marginRight: 2, marginLeft: 2 }, src: imgList['scan'] }),
