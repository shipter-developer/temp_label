...
exports.default = UNI_SHIPENTEGRA;
...
function UNI_SHIPENTEGRA(props) {
    var _a;
    ...
    return (react_1.default.createElement(renderer_1.Page, { key: receiptData['packageInfo']['in_track_no'], size: { width: 432, height: 288 }, style: {
            fontSize: 10,
            padding: 2,
            fontWeight: 'bold',
            lineHeight: 1,
        ...
        react_1.default.createElement(renderer_1.View, { style: { width: '100%', height: '100%', border: '2px solid black', } },
            react_1.default.createElement(renderer_1.View, { style: {
                ...
                react_1.default.createElement(renderer_1.View, { style: { width: '27%', marginLeft: 10, alignItems: 'center', fontSize: 9, display: 'flex', flexDirection: 'row' } },
                    react_1.default.createElement(renderer_1.View, { style: { paddingRight: 10 } },
                        react_1.default.createElement(renderer_1.Image, { src: 'src/img/logo_shipentegra.png' }))),
                react_1.default.createElement(renderer_1.View, { style: { marginRight: 10, display: 'flex', flexDirection: 'row' } },
                    react_1.default.createElement(renderer_1.View, { style: { fontSize: 10, paddingLeft: 20, lineHeight: 1.2, display: 'flex', flexDirection: 'column', alignItems: 'flex-end' } },
                        react_1.default.createElement(renderer_1.Text, { style: { fontSize: 15 } }, ((_a = receiptData === null || receiptData === void 0 ? void 0 : receiptData.etcInfo) === null || _a === void 0 ? void 0 : _a.userdata2) || receiptData.packageInfo.country_code)))),
            react_1.default.createElement(renderer_1.View, { style: {
