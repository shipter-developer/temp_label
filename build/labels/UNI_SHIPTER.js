...
function UNI_SHIPTER(props) {
    ...
    return (react_1.default.createElement(renderer_1.Page, { key: receiptData['packageInfo']['in_track_no'], size: { width: 432, height: 288 }, orientation: "portrait", style: {
        ...
        react_1.default.createElement(renderer_1.View, { style: { width: '100%', height: '100%', border: '2px solid black', } },
            react_1.default.createElement(renderer_1.View, { style: {
                ...
                react_1.default.createElement(renderer_1.View, { style: { marginLeft: 10, alignItems: 'center', fontSize: 9, display: 'flex', flexDirection: 'row' } },
                    ...
                    react_1.default.createElement(renderer_1.View, { style: { paddingRight: 10 } },
                        react_1.default.createElement(renderer_1.Text, null, "www.shipter.kr"),
                        react_1.default.createElement(renderer_1.Text, null, "www.shiptertracking.com"))),
                react_1.default.createElement(renderer_1.View, null, 
                // receiptData.packageInfo.method_name.includes('2') &&
                react_1.default.createElement("div", { style: { border: '2px solid black', borderRadius: 20, padding: '2px 5px 5px 5px' } },
                    react_1.default.createElement(renderer_1.Text, { style: { fontSize: 14, fontWeight: 'bold' } }, "PAK"))),
                react_1.default.createElement(renderer_1.View, { style: { marginRight: 10, display: 'flex', flexDirection: 'row' } },
                    react_1.default.createElement(renderer_1.View, { style: { fontSize: 10, paddingLeft: 20, lineHeight: 1.2, display: 'flex', flexDirection: 'column', alignItems: 'flex-end' } },
                        react_1.default.createElement(renderer_1.Text, { style: { fontSize: 15 } }, (_a = receiptData === null || receiptData === void 0 ? void 0 : receiptData.etcInfo) === null || _a === void 0 ? void 0 : _a.userdata2)))),
            react_1.default.createElement(renderer_1.View, { style: {
                ...
                react_1.default.createElement(renderer_1.View, { style: { display: 'flex', flexDirection: 'row', justifyContent: 'space-between', height: '100%', width: '100%' } },
                    ...
                    react_1.default.createElement(renderer_1.View, { style: { height: '100%', minWidth: '30%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' } },
                        react_1.default.createElement(renderer_1.View, { style: { margin: -1, border: '1px solid black', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' } },
                            react_1.default.createElement(renderer_1.View, { style: { padding: '0px 5px', paddingBottom: 5 } },
                                react_1.default.createElement(renderer_1.Text, { style: { fontSize: 30, fontWeight: 'bold' } },
                                    receiptData.packageInfo.country_code,
                                    ((_b = receiptData === null || receiptData === void 0 ? void 0 : receiptData.etcInfo) === null || _b === void 0 ? void 0 : _b.userdata1) && ('-' + ((_c = receiptData === null || receiptData === void 0 ? void 0 : receiptData.etcInfo) === null || _c === void 0 ? void 0 : _c.userdata1)))))))),
            ...
            react_1.default.createElement(renderer_1.View, { style: { height: '32%', width: '100%', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' } },
                react_1.default.createElement(renderer_1.View, { style: { width: '70%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' } },
